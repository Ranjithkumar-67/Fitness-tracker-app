    ...
    if (ctx && !weightChart) {
        weightChart = new Chart(ctx, {
            ...
            options: {
                ...
                aspectRatio: window.innerWidth < 480 ? 1.5 : 2.5,
                plugins: {
                    legend: {
                        position: 'top',
                    },
...
(function() {
    ...
    function fixNavigation() {
        ...
        navLinks.forEach(link => {
            ...
            newLink.addEventListener('touchstart', handleNavClick);
        });
        ...
        function handleNavClick(e) {
            ...
            // Update pages - force hide all first
            pages.forEach(p => {
    ...
    // Run again after 1 second to override any conflicts
